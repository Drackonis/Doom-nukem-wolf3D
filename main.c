...
/*   Updated: 2020/03/10 12:07:11 by rkergast         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_gettexture(t_data *data)
{
	data->tex1.tex = mlx_xpm_file_to_image(&data->mlx_ptr,
				"./Texture09.xpm", &data->tex1.widthTex, &data->tex1.heighTex);
	...
	data->tex2.tex = mlx_xpm_file_to_image(&data->mlx_ptr,
				"./Texture06.xpm", &data->tex2.widthTex, &data->tex2.heighTex);
	...
	data->tex3.tex = mlx_xpm_file_to_image(&data->mlx_ptr,
				"./Texture07.xpm", &data->tex3.widthTex, &data->tex3.heighTex);
	...
	data->tex4.tex = mlx_xpm_file_to_image(&data->mlx_ptr,
				"./Texture08.xpm", &data->tex4.widthTex, &data->tex4.heighTex);
